...
//
// Audio sync edits made by Logan D'Auria
// 
...
namespace DigitalRuby.LightningBolt
{
    ...
    public class LightningBoltScript : AudioSyncer
    {
        ...
        public void GenerateLightningBolt(Vector3 start, Vector3 end, int generation, int totalGenerations, float offsetAmount)
        {
