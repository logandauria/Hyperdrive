...
public class AudioSyncColor : AudioSyncer {
	...
	{
		if (beatColors == null || beatColors.Length == 0) return Color.black;
	...
	public override void OnUpdate()
	{
		...
		m_img.GetComponent<MeshRenderer>().material.color = Color.Lerp(m_img.color, restColor, restSmoothTime * Time.deltaTime);
	}
